...
description: "Kimi K3 API review: ¥2/M cached input, ¥20/M uncached input, ¥100/M output. 1M context, vision, tools, K2 alternatives."
pubDate: "2026-07-31"
provider: kimi
category: review
featured: true
...
curl https://api.moonshot.cn/v1/chat/completions \
  --header "Authorization: Bearer YOUR_K...KEY" \
...
For an external multi-provider control plane, you can also test Kimi alongside other endpoints through FreeModel API access. Use that as an evaluation and routing option, not as a reason to ignore the upstream provider's model IDs, usage accounting, or regional terms.
